...
int main ( int argc, char * argv [] )
{
	...
	const char * source = loadFile( "matrixMul-2.cl" );
	...
	clSetKernelArg( kernel, 3, sizeof(float) * BLOCK_SIZE *BLOCK_SIZE, NULL );
	clSetKernelArg( kernel, 4, sizeof(float) * BLOCK_SIZE *BLOCK_SIZE, NULL );
