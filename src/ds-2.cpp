...
public:
	MyWindow () : GlutWindow ( 200, 200, 640, 480, "Deferred Shading" )
	{
		...
		fb.attachColorTexture ( fb.createColorTexture ( GL_RGBA, GL_RGBA16F ), 2 );
		...
		if ( !program.loadProgram ( "ds-2-1.glsl" ) )
		{
		...
		if ( !program2.loadProgram ( "ds-2-2.glsl" ) )
		{
